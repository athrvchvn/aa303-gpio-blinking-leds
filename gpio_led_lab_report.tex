...
\begin{figure}[H]
\centering
\includegraphics[width=0.46\textwidth, trim=0 330 0 400, clip]{figures/setup_leds_on.jpg}
\caption{Experiment 1 --- the four LEDs on the breadboard during the blink cycle, with
the jumper wires running to the GPIO header and all cathodes on the common ground rail.}
\label{fig:photo-rpi}
\end{figure}
